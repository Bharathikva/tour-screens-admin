...
const Dashboard = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-50 transition-all duration-300 ease-in-out">
      {/* Sidebar */}
      <aside
        className={`w-64 bg-blue-900 p-6 border-r transition-transform duration-500 ease-in-out ${
          sidebarOpen ? "transform-none" : "-translate-x-64"
        }`}
      >
